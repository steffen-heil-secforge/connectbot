...
public class PuttyRegistryParserTest {
	...
	public void testParsePortForwards() throws Exception {
		...
		PortForwardBean local = findPortForwardByTypeAndPort(portForwards, "Local", 8080);
		PortForwardBean remote = findPortForwardByTypeAndPort(portForwards, "Remote", 9090);
		PortForwardBean dynamic = findPortForwardByTypeAndPort(portForwards, "Dynamic (SOCKS)", 1080);

		assertValidPortForward(local, "Local", 8080, "localhost", 80);
		assertValidPortForward(remote, "Remote", 9090, "0.0.0.0", 443);
	...
	private void assertValidDynamicPortForward(PortForwardBean pf, int sourcePort) {
		assertNotNull(pf);
		assertEquals("Dynamic (SOCKS)", pf.getType());
		assertEquals(sourcePort, pf.getSourcePort());
	...
	public void testPortForwardIntegrationInParseResult() throws Exception {
		...
		PortForwardBean local = findPortForwardByTypeAndPort(forwards, "Local", 8080);
		PortForwardBean remote = findPortForwardByTypeAndPort(forwards, "Remote", 9090);
		PortForwardBean dynamic = findPortForwardByTypeAndPort(forwards, "Dynamic (SOCKS)", 1080);
	...
	public void testParsePortForwardsIPv6() throws Exception {
		...
		assertEquals("Local", forwards1.get(0).getType());
		...
		assertEquals("Dynamic (SOCKS)", forwards3.get(0).getType());
	}
